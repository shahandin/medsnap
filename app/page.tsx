          ...
          <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center px-4">
              <Button
                ...
                asChild
              >
                <Link href="/application?fresh=true" className="flex items-center justify-center gap-2">
                  Apply for Benefits
        ...
        <section className="relative py-12 md:py-24 lg:py-32 bg-white overflow-hidden">
          <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/application?fresh=true" className="flex items-center justify-center gap-3">
