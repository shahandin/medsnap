        ...
        <div className="container mx-auto px-4 max-w-4xl">
          {!user && (
            <Alert className="mb-6 border-orange-300 bg-orange-50">
              ...
              <AlertDescription className="text-orange-800">{t("success.sessionWarning")}</AlertDescription>
            </Alert>
          )}
          ...
          <Card className="mb-8 border-green-200 bg-green-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-green-800">
                ...
                {t("success.applicationDetails.title")}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <p className="font-medium text-gray-700">{t("success.applicationDetails.referenceNumber")}</p>
                  <p className="text-lg font-mono bg-white px-3 py-1 rounded border">{referenceNumber}</p>
                </div>
                <div>
                  <p className="font-medium text-gray-700">{t("success.applicationDetails.submissionDate")}</p>
              ...
              <Alert className="bg-green-100 border-green-300">
                ...
                <AlertDescription className="text-green-800">
                  {t("success.applicationDetails.saveReference")}
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>{t("success.nextSteps.description")}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{t("success.nextSteps.step1.title")}</h3>
                    <p className="text-gray-600 text-sm">{t("success.nextSteps.step1.description")}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{t("success.nextSteps.step2.title")}</h3>
                    <p className="text-gray-600 text-sm">{t("success.nextSteps.step2.description")}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{t("success.nextSteps.step3.title")}</h3>
                    <p className="text-gray-600 text-sm">{t("success.nextSteps.step3.description")}</p>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-xl mt-0.5">📞</span>
                  <div>
                    <p className="font-medium">{t("success.importantInfo.updateContact.title")}</p>
                    <p className="text-sm text-gray-600">{t("success.importantInfo.updateContact.description")}</p>
                  </div>
                </div>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>{t("success.quickActions.description")}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4">
                <Button
                  ...
                  {user ? (
                    <Link href="/about">
                      <div className="flex items-center gap-3">
                        <span className="text-xl">🔗</span>
                        <div className="text-left">
                          <p className="font-medium">{t("success.quickActions.learnMore.title")}</p>
                          <p className="text-sm text-gray-600">{t("success.quickActions.learnMore.description")}</p>
                        </div>
                      </div>
                    </Link>
                  ) : (
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <p className="font-medium">{t("success.quickActions.learnMore.title")}</p>
                        <p className="text-sm text-gray-600">{t("success.quickActions.learnMore.signInRequired")}</p>
                      </div>
                    </div>
                  )}
                </Button>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-gray-600">{t("success.needHelp.description")}</p>
                <div className="grid md:grid-cols-2 gap-4">
