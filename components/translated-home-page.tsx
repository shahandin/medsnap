          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-4">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border/50 hover:border-primary/20 bg-card/50 backdrop-blur-sm rounded-2xl overflow-hidden">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-heading font-semibold">
                  {t("home.features.easyApplication.title")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base leading-relaxed">
                  {t("home.features.easyApplication.description")}
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border/50 hover:border-primary/20 bg-card/50 backdrop-blur-sm rounded-2xl overflow-hidden">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-heading font-semibold">
                  {t("home.features.securePrivate.title")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base leading-relaxed">
                  {t("home.features.securePrivate.description")}
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-border/50 hover:border-primary/20 bg-card/50 backdrop-blur-sm rounded-2xl overflow-hidden">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-heading font-semibold">
                  {t("home.features.aiEnabled.title")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base leading-relaxed">
                  {t("home.features.aiEnabled.description")}
                </CardDescription>
              </CardContent>
            </Card>
          </div>
