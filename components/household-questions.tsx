    ...
    return (
      <div className="mt-4 p-4 bg-gray-50 rounded-lg">
        <Label className="text-sm font-medium text-gray-700 mb-3 block">
          {t("forms.householdQuestions.selectHouseholdMembers")}
        </Label>
      ...
      <Card>
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="space-y-3">
            <Label className="text-base font-medium">{t("forms.householdQuestions.appliedWithDifferentInfo")}</Label>
            <RadioGroup
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="different-info-yes">{t("forms.householdQuestions.yes")}</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="no" id="different-info-no" />
                <Label htmlFor="different-info-no">{t("forms.householdQuestions.no")}</Label>
              </div>
            </RadioGroup>
          ...
          <div className="space-y-3">
            <Label className="text-base font-medium">{t("forms.householdQuestions.appliedInOtherState")}</Label>
            <RadioGroup
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="other-state-yes">{t("forms.householdQuestions.yes")}</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="no" id="other-state-no" />
                <Label htmlFor="other-state-no">{t("forms.householdQuestions.no")}</Label>
              </div>
            </RadioGroup>
          ...
          <div className="space-y-3">
            <Label className="text-base font-medium">{t("forms.householdQuestions.receivedBenefitsBefore")}</Label>
            <RadioGroup
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="received-before-yes">{t("forms.householdQuestions.yes")}</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="no" id="received-before-no" />
                <Label htmlFor="received-before-no">{t("forms.householdQuestions.no")}</Label>
              </div>
            </RadioGroup>
            ...
            <>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-medium text-blue-900 mb-4">
                  {t("forms.householdQuestions.snapSpecificQuestions")}
                </h3>

                {/* Question 4: Receiving SNAP this month */}
                <div className="space-y-3 mb-6">
                  <Label className="text-base font-medium text-blue-900">
                    {t("forms.householdQuestions.receivingSNAPThisMonth")}
                  </Label>
                  <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="snap-this-month-yes">{t("forms.householdQuestions.yes")}</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="no" id="snap-this-month-no" />
                      <Label htmlFor="snap-this-month-no">{t("forms.householdQuestions.no")}</Label>
                    </div>
                  </RadioGroup>
                ...
                <div className="space-y-3 mb-6">
                  <Label className="text-base font-medium text-blue-900">
                    {t("forms.householdQuestions.disqualifiedFromBenefits")}
                  </Label>
                  <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="disqualified-yes">{t("forms.householdQuestions.yes")}</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="no" id="disqualified-no" />
                      <Label htmlFor="disqualified-no">{t("forms.householdQuestions.no")}</Label>
                    </div>
                  </RadioGroup>
                ...
                <div className="space-y-3">
                  <Label className="text-base font-medium text-blue-900">
                    {t("forms.householdQuestions.wantSomeoneElseToReceiveSNAP")}
                  </Label>
                  <p className="text-sm text-blue-700">{t("forms.householdQuestions.authorizedRepresentativeInfo")}</p>
                  <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="someone-else-snap-yes">{t("forms.householdQuestions.yes")}</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="no" id="someone-else-snap-no" />
                      <Label htmlFor="someone-else-snap-no">{t("forms.householdQuestions.no")}</Label>
                    </div>
                  </RadioGroup>
