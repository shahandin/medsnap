...
const getButtonClasses = (variant = "default", size = "default") => {
  ...
  const sizeClasses = {
    default: "h-10 sm:h-9 px-4 py-2 has-[>svg]:px-3 min-h-[44px] sm:min-h-0",
    sm: "h-9 sm:h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5 min-h-[40px] sm:min-h-0",
    lg: "h-12 sm:h-10 rounded-md px-6 has-[>svg]:px-4 min-h-[48px] sm:min-h-0",
    icon: "size-10 sm:size-9 min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0",
  }
