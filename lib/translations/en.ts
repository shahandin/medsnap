...
export const en: TranslationData = {
  ...
  dashboard: {
    ...
    applications: {
      ...
      description: "View and manage all your benefit applications in one place.",
    ...
    notifications: {
      title: "Notifications",
      description: "Stay updated with important information about your applications and benefits.",
    ...
    documents: {
      ...
      description: "Upload required documents to support your benefits application.",
      uploadNewDocument: "Upload New Document",
      documentType: "Document Type",
      selectDocumentType: "Select document type",
      chooseFile: "Choose File",
      noFileChosen: "No file chosen",
      acceptedFormats: "Accepted formats: PDF, JPG, PNG, DOC, DOCX (Max 10MB)",
    ...
    reportChanges: {
      ...
      description: "It's important to report changes that might affect your benefits within 10 days.",
      categories: {
        incomeAssets: {
          title: "Income & Assets",
          description: "Report changes in employment, income, or assets like bank accounts and property.",
        },
        household: {
          title: "Household Changes",
          description: "Report changes in household members, marriage, divorce, or family composition.",
        },
        address: {
          title: "Address & Residency",
          description: "Report address changes or moves to a different state or county.",
        },
        insurance: {
          title: "Health Insurance",
          description: "Report changes in health insurance coverage, Medicare eligibility, or job-based insurance.",
        },
      },
      form: {
        changeType: "What type of change are you reporting?",
        selectChangeType: "Select the type of change",
        relationship: "Relationship to you",
        selectRelationship: "Select relationship",
        changeDate: "When did this change occur?",
        details: "Please provide additional details about this change",
        detailsPlaceholder: "Describe the change and any relevant information...",
        back: "Back",
        submitChange: "Submit Change",
        submitting: "Submitting...",
        successTitle: "Change Reported Successfully",
        successDescription: "Your change has been submitted and will be processed within 2-3 business days.",
      },
    },
    profile: {
      ...
      communicationDescription: "Choose how you'd like to receive important updates and notifications.",
      preferredContactMethod: "Preferred Contact Method",
      mailingAddress: "Mailing Address",
      languagePreferences: "Language Preferences",
      languageDescription: "Select your preferred language for documents and communications.",
  ...
  forms: {
    ...
    healthDisability: {
      ...
      subtitle: "Provide health insurance details and answer questions about disabilities and medical conditions.",
      disabilityInformation: "Disability Information",
      disabilityQuestions: "Disability Questions",
      hasDisabled: "Is anyone in the household disabled?",
      disabilityDetails: "Please provide details about the disability",
      disabilityPlaceholder: "Describe the disability and how it affects daily activities...",
      needsLongTermCare: "Is anyone in the household in need of long-term care?",
      longTermCareDetails: "Please provide details about long-term care needs",
      longTermCarePlaceholder: "Describe the long-term care needs...",
      hasIncarcerated: "Is anyone in the household incarcerated?",
      incarcerationDetails: "Please provide details about incarceration",
      incarcerationPlaceholder: "Provide details about the incarceration status...",
      ...
      selectPregnantMember: "Select household member",
      dueDate: "Expected Due Date",
      medicalConditionsInformation: "Medical Conditions",
      ...
      selectConditions: "Select all that apply:",
      conditionDetails: "Additional details (optional)",
      conditionDetailsPlaceholder: "Provide any additional details about medical conditions...",
      medicalBillsInformation: "Medical Bills & Expenses",
      ...
      longTermCareServices: "Long-Term Care Services",
      longTermCareServicesDescription: "Information about nursing home or long-term care services",
      needsNursingServices: "Are you applying for long-term nursing services from a nursing home or similar facility?",
      needsNursingServicesYes: "Yes, I need long-term nursing services",
      needsNursingServicesNo: "No, I do not need long-term nursing services",
      nursingServicesHelp:
      ...
      hasHealthInsurance: "Do you have health insurance?",
      addInsuranceInfo: "Add Insurance Info",
      ...
      disabilitySpecialCircumstances: "Disability & Special Circumstances",
      disabilitySpecialCircumstancesDescription: "Answer these questions about household members",
      conditionsList: [
        "Diabetes",
        "High Blood Pressure",
        "Heart Disease",
  ...
  formFields: {
    ...
    additionalDetails: "Additional details about this income source",
    selectType: "Select type",
    employmentStatus: "Employment Status",
    ...
    pregnancyInformation: "Pregnancy Information",
    informationAboutPregnancy: "Information about pregnancy in the household",
    isAnyonePregnant: "Is anyone in the household pregnant?",
    medicalConditions: "Medical Conditions",
    chronicConditions: "Chronic conditions that may affect benefit eligibility",
    doesAnyoneHaveConditions: "Does anyone have chronic medical conditions?",
    ...
    addInsuranceInfo: "Add Insurance Info",
    disabilitySpecialCircumstances: "Disability & Special Circumstances",
    answerQuestionsAboutMembers: "Answer these questions about household members",
    isAnyoneDisabled: "Is anyone in the household disabled?",
    isAnyoneInNeedOfLongTermCare: "Is anyone in the household in need of long-term care?",
    housingLivingExpenses: "Housing & Living Expenses",
    monthlyHousingCosts: "Monthly housing costs and living expenses for your household",
    addRegularExpenses: "Add your regular housing and utility expenses",
    addHousingExpense: "Add Housing Expense",
    noHousingExpensesAdded: "No housing expenses added yet",
    clickAddHousingExpense: 'Click "Add Housing Expense" to get started',
    taxDeductibleExpenses: "Tax Deductible Expenses",
    expensesThatReduce: "Expenses that may reduce your taxable income",
    addExpense: "Add Expense",
    oneEmploymentEntry: "1 employment entry",
    addJob: "Add Job",
    addMore: "Add More",
    remove: "Remove",
  },
