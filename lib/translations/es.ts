  ...
  forms: {
    ...
    household: {
      ...
      householdInclusionInfo:
        "Incluye a cualquier persona que viva contigo regularmente, comparta comidas o contribuya a los gastos del hogar. Esto incluye cónyuges, hijos, padres y otros parientes o personas no relacionadas que vivan en tu hogar.",
    ...
    health: {
      ...
      currentHealthInsurance: "Cobertura de Seguro de Salud Actual",
      addInsuranceCoverage: "Agregar Cobertura de Seguro",
      selectCoverageType: "Selecciona el tipo de cobertura",
      ...
      addMedicalCondition: "Agregar Condición Médica",
      insuranceTypes: {
        employerSponsored: "Patrocinado por el Empleador",
    ...
    review: {
      ...
      sessionExpiredError: "Tu sesión ha expirado. Por favor inicia sesión de nuevo e intenta enviar tu solicitud.",
      submissionError: "Hubo un error al enviar tu solicitud. Por favor intenta de nuevo.",
      unexpectedError:
        "Hubo un error inesperado al enviar tu solicitud. Por favor intenta de nuevo o contacta soporte.",
      frequencies: {
        weekly: "Semanal",
        monthly: "Mensual",
        quarterly: "Trimestral",
